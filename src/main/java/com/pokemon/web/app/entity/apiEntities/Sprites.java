...
public class Sprites {
	...
	public List<String> getImages() {
		...
		images.add(this.getBack_default());
		images.add(this.getBack_female());
		images.add(this.getBack_shiny());
		images.add(this.getBack_shiny_female());
		images.add(this.getFront_default());
		images.add(this.getFront_female());
		images.add(this.getFront_shiny());
		images.add(this.getFront_shiny_female());
		return images;
	}
